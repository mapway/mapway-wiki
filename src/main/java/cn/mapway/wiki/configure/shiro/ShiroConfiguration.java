...
import cn.mapway.wiki.services.ApplicationRealm;
...
public class ShiroConfiguration {
	...
	private static final Log logger = Logs.getLog(ShiroConfiguration.class);
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(org.apache.shiro.mgt.SecurityManager securityManager) {
		...
		shiroFilterFactoryBean.setUnauthorizedUrl("/errors/403");
		...
		filterChainDefinitionMap.put("/fileserver", "anon");
	 ...
	 */
	@Bean
	public ApplicationRealm userRealm() {
		ApplicationRealm userRealm = new ApplicationRealm();
